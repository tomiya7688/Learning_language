...
game_over_sub_font = pygame.font.Font(None, 32)
...
while running:
    ...
    if game_state == "game_over":
        ...
        game_over_sub_text = game_over_sub_font.render(
            "Your HP reached 0.",
            True,
            (255, 255, 255)
        )
        ...
        screen.blit(game_over_sub_text, game_over_sub_text_rect)
