...
## 15-15. JSONはWeb APIでもよく使う

次の章で扱うWeb APIでは、JSONがよく使われます。
...
つまり、この章のJSONは次のWeb APIへそのままつながります。

---

## 15-16. CSVやJSONもただのファイル
